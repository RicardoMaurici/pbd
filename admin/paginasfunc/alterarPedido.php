...
<div class="panel panel-default col-md-10 col-md-offset-1">
  ...
  <div class="panel-body">
            ...
            <table id="mytable" class="table table-bordred table-striped">    
                ...
                <tbody>
                  ...
                  <tr> <!--Vai preenchendo de acordo que adiciona item-->
                      ...
                      <td>100</td>
                      <td>R$ 9,90</td>
                      <td><button id="altItem" name="altItem" class="btn btn-warning btn-xs" data-title="alt" data-toggle="modal" data-target="#alt" data-placement="top" rel="tooltip">Alterar</button></td>
    ...
    <div class="form-group">
      ...
      <a href="pedidoMaterial.php" class="btn btn-warning" style="width: 25%;">Alterar Pedido</a>
    </div>
</div>
</div>
  
<div class="modal fade" id="alt" tabindex="-1" role="dialog" aria-labelledby="alt" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title custom_align" id="Heading">Alterando Item</h4>
      </div>
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="lbqtd" class="col-sm-2 control-label">Quantidade Solicitada</label>
          <div class="col-sm-2">
          ...
          <label for="lbqtd" class="col-sm-2 control-label">Quantidade Fornecida</label>
          <div class="col-sm-2">
                <select class="form-control" id="slqtd">
                  <option>0</option> 
                  <option>1</option>
          ...
          <label for="lbvalor" class="col-sm-1 control-label">Valor Unidade</label>
            <div class="col-sm-2">
