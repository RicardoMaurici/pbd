...
if(isset($_POST['alterar'])){
	...
	if(time() <= strtotime($_POST['inicioInscCurso']) AND strtotime($_POST['inicioInscCurso']) < strtotime($_POST['terminoInscCurso']) AND
		strtotime($_POST['terminoInscCurso']) < strtotime($_POST['inicioMatCurso']) AND strtotime($_POST['inicioMatCurso']) < strtotime($_POST['terminoMatCurso'])){
