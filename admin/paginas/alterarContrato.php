...
<div class="panel panel-default col-md-10 col-md-offset-1">
  <div class="panel-heading">
    <h3 class="panel-title">Alteração do Contrato de Doação</h3>
  </div>
  <div class="panel-body">
    ...
    <div class="form-group">
      ...
      <button type="button" class="btn btn-warning" style="width: 25%;" id="alterarContrato">Alterar Contrato</button>
