...
<div class="panel panel-default col-md-10 col-md-offset-1">
  ...
  <div class="panel-body">
  	<form class="form-horizontal" role="form" method="post" action="bd/cad_funcionario.php">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="date" class="form-control" required id="idtNascimento" name="idtNascimento" placeholder="Data de nascimento">
        </div>
        <div class="col-sm-3">
          ...
          <div class="col-sm-4">
            <select class="form-control" id="cargo" name="cargo"> <!--infomacao vem do banco-->
              <?php
                ...
                while($row=mysql_fetch_array($result)){
              ?>
                <option value=<?php echo $row['idFuncao'];?>><?php echo $row['descricao']."; Expediente: ".$row['hrInicio']." - ".$row['hrFim']; ?></option>
              <?php } ?>
            </select>
          </div>
      </div>
